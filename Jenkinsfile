    ...
    stages {
        ...
        stage('Moving Angular Appo to BackEnd') {
            steps {         
                ...
                sh 'cp -R Portfolio/dist/portfolio Portfolio_BackEnd/Portfolio_BackEnd/src/main/resources'
                  
                //erase existing public folder
                sh "if [ -d Portfolio_BackEnd/Portfolio_BackEnd/src/main/resources/public ]; then rm -Rf Portfolio_BackEnd/Portfolio_BackEnd/src/main/resources/public; fi"

                //rename portfolio to public
                sh 'mv Portfolio_BackEnd/Portfolio_BackEnd/src/main/resources/portfolio Portfolio_BackEnd/Portfolio_BackEnd/src/main/resources/public'
        ...
        stage('Build') {
            steps { 
                echo 'Building...' 
                dir("Portfolio_BackEnd/Portfolio_BackEnd") {
                    sh "pwd"
